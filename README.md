...
This repository serves as a central hub for showcasing my coursework and technical projects for my CIS 352 COBOL assigments.
...
| [RPT2000](#rpt2000) | COBOL | CIS352 | Generates a YTD sales report with year-over-year comparisons and grand totals | Garrett Finke | [RPT2000](https://github.com/gafink01/RPT2000) |
...
| [SEQ3000](#seq3000) | COBOL | CIS352 | A sequential file program that adds, changes, and deletes transactions while generating updated master and error files | Garrett Finke | [SEQ3000](https://github.com/gafink01/SEQ3000-ASSIGMENT.git) |
---
